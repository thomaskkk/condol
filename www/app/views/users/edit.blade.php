                    ...
                    usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
                        ...
                        <div>
                            ...
                            <div class="widget-body no-padding">
                                {{ Form::model($morador, array('id' => 'main-form', 'class' => 'smart-form', 'novalidate' => 'novalidate', 'route' => array('moradores.update', $morador->id), 'method' => 'PUT')) }}
                                {{-- <header></header> --}}
                                <fieldset>
                                    <div class="row">
                                        <section class="col col-6">
                                            <label class="input">
                                                ...
                                                {{ Form::text('nome', null, array('placeholder' => 'Nome Completo')) }}
                                            </label>
                                        </section>
                                        <section class="col col-6">
                                            <label class="input">
                                    ...
                                    <div class="row">
                                        <section class="col col-4">
                                            <label class="input">
                                                ...
                                                {{ Form::text('aniversario', null, array(
                                        ...
                                        <section class="col col-4">
                                            <label class="input">
                                                ...
                                                {{ Form::text('tel_contato', null, array(
