...
@section('content')
@include('layouts.create.top', array('errors' => $errors, 'icon' => 'fa-group', 'controler_name' => 'Grupos', 'submit_route' => 'groups'))
...
@include('layouts.create.bottom', array('cancel_route'=>'groups'))
@stop
